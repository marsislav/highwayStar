      ...
      <div class="container">
              ...
              <div class="defPages">
                  <?php
                    ...
                    <a href="<?php the_permalink (get_theme_mod( 'hs_footer_tos_page'));?>"><?php _e('Terms of Service', 'hs');?></a>
                   <?php }
                  ?>
                  <?php
                    if (get_theme_mod('hs_footer_privacy_page')){?>
                    <a href="<?php the_permalink (get_theme_mod( 'hs_footer_privacy_page'));?>"><?php _e('Privacy Policy', 'hs');?></a>
                   <?php }
                  ?>
              </div>
            </div>
